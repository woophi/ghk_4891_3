...
export const App = () => {
  ...
  const submit = () => {
    window.gtag('event', '4891_confirm_var3');
    setLoading(true);
  ...
  const openCalc = () => {
    window.gtag('event', '4891_calc_var3');
    setOpenBs(true);
  };
    ...
    <>
      <div className={appSt.container}>
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '4891_FAQ1_var3');
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '4891_FAQ2_var3');
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '4891_FAQ3_var3');
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '4891_FAQ4_var3');
        ...
        <div
          onClick={() => {
            window.gtag('event', '4891_moreinfo_var3');
